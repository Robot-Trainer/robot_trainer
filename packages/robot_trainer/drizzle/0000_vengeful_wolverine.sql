...
CREATE TABLE "datasets" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "datasets_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
CREATE TABLE "robot_models" (
	...
	"sim_properties" json DEFAULT '{}'::json,
	"real_properties" json DEFAULT '{}'::json,
	"model_xml" text,
	"model_path" varchar,
	"model_format" varchar,
	"supported_modalities" "robotModality"[] DEFAULT '{"simulated"}',
	"created_at" timestamp with time zone DEFAULT now()
);
--> statement-breakpoint
CREATE TABLE "robots" (
...
--> statement-breakpoint
ALTER TABLE "datasets" ADD CONSTRAINT "datasets_skill_id_skills_id_fk" FOREIGN KEY ("skill_id") REFERENCES "public"."skills"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "datasets" ADD CONSTRAINT "datasets_scene_id_scenes_id_fk" FOREIGN KEY ("scene_id") REFERENCES "public"."scenes"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "episodes" ADD CONSTRAINT "episodes_dataset_id_datasets_id_fk" FOREIGN KEY ("dataset_id") REFERENCES "public"."datasets"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "scene_teleoperators" ADD CONSTRAINT "scene_teleoperators_teleoperator_id_teleoperator_models_id_fk" FOREIGN KEY ("teleoperator_id") REFERENCES "public"."teleoperator_models"("id") ON DELETE cascade ON UPDATE no action;
...
CREATE TABLE "robot_models" (
	...
	"teleoperator" boolean DEFAULT false,
	"created_at" timestamp with time zone DEFAULT now()
);
--> statement-breakpoint
CREATE TABLE "robots" (
...
ALTER TABLE "scene_teleoperators" ADD CONSTRAINT "scene_teleoperators_teleoperator_id_robot_models_id_fk" FOREIGN KEY ("teleoperator_id") REFERENCES "public"."robot_models"("id") ON DELETE cascade ON UPDATE no action;